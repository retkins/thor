...
pub fn h_point(centroid: &[f64; 3], vj: &[f64; 3], radius:  f64, target: &[f64; 3]) -> [f64;3] {
    let r: [f64; 3] = [target[0] - centroid[0], target[1] - centroid[1], target[2] - centroid[2]];
    let mut vjr = [0.0; 3];
    cross(vj, &r, &mut vjr);
    let rmag = mag3(r[0], r[1], r[2]);
