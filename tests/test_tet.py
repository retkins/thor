...
err_direct_pt_axis = thor.test_utils.smape(bmag_direct_tet_axis, bmag_direct_pt_axis)
err_octree_pt_axis = thor.test_utils.smape(bmag_direct_tet_axis, bmag_octree_pt_axis)
err_octree_tet_axis = thor.test_utils.smape(bmag_direct_tet_axis, bmag_octree_tet_axis)
